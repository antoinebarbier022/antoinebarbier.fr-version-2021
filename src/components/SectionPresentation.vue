<template>
    <section class="presentation-content">
            <div class="presentation-photo">
                <figure class="big-profile-image"> <!-- class="gradiant-bloc" -->
                    <!--
            ...
            <div class="content">
                <h2>Stagiaire en tant que <strong>développeur front-end</strong> chez frog <span id="entreprise-name-extension">part of Capegemini invent</span></h2>
                <p>
                    Diplomé en 2022 d'un <strong>Master en Génie Logiciel</strong>, je termine mon stage de fin d'études le 15 juillet 2022 avec l'entreprise <strong>frog</strong>, une filiale internationale de Capgemini.
                </p>
     
                <ul class="social-network">
                    <li class="icon1"><a href="https://www.linkedin.com/in/antoinebarbier022/" target="_blank" role="link" title="Linkedin : antoinebarbier022">
                    ...
                    <li class="icon2"><a href="https://www.instagram.com/antoineb_dev/" target="_blank" role="link" title="Instagram : @antoineb_dev">
...
span#entreprise-name-extension {
    display:none;
font-size: 0.9rem;
font-weight: lighter;
}
...
.presentation-photo{
    ...
    width: calc((100vw - 840px) / 2 + 840px - 420px);
    height: 45vw;
    max-height: 500px;
