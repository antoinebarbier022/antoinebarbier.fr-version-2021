    ...
    <div class="project-detail-container">
      <div class="thumbnail-slider">
        <Splide ref="main" id="main-slider" :options="optionsMain">
          <SplideSlide
            v-for="element in project?.images"
            v-bind:key="element.id"
          >
            <img :src="`/assets/images/${element.image}`" :alt="element.alt" />
          </SplideSlide>
        </Splide>
      ...
      <div class="project-detail">
        <div class="project-detail-content">
          ...
          <p v-if="!parserDescription" class="no-description noselect">
            Il n'y a pas encore de description pour ce projet.
          </p>
          <div class="tags">
    ...
    return {
      ...
      projectList: [
        ...
        },
        {
          ...
          annee: "2021",
          description:
            "Membres du groupe : Antoine Barbier et Djamel Benameur.",
          membres: [
            { name: "Antoine Barbier", url: "https://www.antoinebarbier.fr" },
            {
              name: "Djamel Benameur",
              url: "https://fr.linkedin.com/in/djamel-benameur-9a1704130",
            },
          ],
          images: [
            {
          ...
          tags: [{ name: "Java" }, { name: "Python" }],
          website: "",
          gitlab:
            "https://gitlab.com/An_toine/implementation-d-un-mini-moteur-de-requetes-en-etoile",
          github:
            "https://github.com/antoinebarbier022/implementation-d-un-mini-moteur-de-requetes-en-etoile",
        },
        {
          ...
          tags: [{ name: "Flutter" }, { name: "API" }, { name: "openweather" }],
          website: "",
          gitlab:
            "https://gitlab.com/An_toine/hai912i-td-antoine-barbier/-/tree/main/weather_app",
          github:
            "https://github.com/antoinebarbier022/td-mobile-flutter/tree/main/weather_app",
        },
        {
          ...
          images: [
            {
              image: "projet-plateforme-stages/infoStage.png",
              alt: "Plateforme de gestion de stage Informatique pour la faculté des sciences de Montpellier",
            },
            {
              image: "projet-plateforme-stages/infoStage1.png",
              alt: "Plateforme de gestion de stage Informatique pour la faculté des sciences de Montpellier",
            },
            {
              image: "projet-plateforme-stages/infoStage2.png",
              alt: "Plateforme de gestion de stage Informatique pour la faculté des sciences de Montpellier",
            },
            {
              image: "projet-plateforme-stages/infoStage3.png",
              alt: "Plateforme de gestion de stage Informatique pour la faculté des sciences de Montpellier",
            },
            {
              image: "projet-plateforme-stages/infoStage4.png",
              alt: "Plateforme de gestion de stage Informatique pour la faculté des sciences de Montpellier",
            },
            {
              image: "projet-plateforme-stages/infoStage5.png",
              alt: "Plateforme de gestion de stage Informatique pour la faculté des sciences de Montpellier",
            },
          ],
          tags: [
        ...
        },
        {
          ...
          images: [
            ...
            {
              image: "projet-reseau-social/android1.png",
              alt: "Réseau Social Android Socializing",
            },
            {
              image: "projet-reseau-social/android2.png",
              alt: "Réseau Social Android Socializing",
            },
            {
              image: "projet-reseau-social/android3.png",
              alt: "Réseau Social Android Socializing",
            },
            {
              image: "projet-reseau-social/android4.png",
              alt: "Réseau Social Android Socializing",
            },
            {
              image: "projet-reseau-social/android5.png",
              alt: "Réseau Social Android Socializing",
            },
            {
              image: "projet-reseau-social/android6.png",
              alt: "Réseau Social Android Socializing",
            },
            {
              image: "projet-reseau-social/android7.png",
              alt: "Réseau Social Android Socializing",
            },
            {
              image: "projet-reseau-social/android8.png",
              alt: "Réseau Social Android Socializing",
            },
          ],
          tags: [
        ...
        },
        {
          ...
          website: "",
          gitlab:
            "https://gitlab.com/An_toine/hmin105m-projet-systeme-de-reservation-distribue",
          github: "",
          document:
            "https://gitlab.com/An_toine/hmin105m-projet-systeme-de-reservation-distribue/-/blob/master/consignes-projet-concurente.pdf",
        },
        {
          ...
          annee: "2019",
          description:
            "Membres du projets : Antoine Barbier, Djamel Benameur, Timoléon Demas, Matthieu Commins, Thomas Zaragoza.",
          membres: [
            { name: "Antoine Barbier", url: "https://www.antoinebarbier.fr" },
            {
              name: "Djamel Benameur",
            ...
            {
              name: "Matthieu Commins",
              url: "https://fr.linkedin.com/in/matthieu-commins-3651a1159",
            },
            {
              name: "Thomas Zaragoza",
              url: "https://fr.linkedin.com/in/thomas-zaragoza-bab653160",
            },
          ],
          images: [
            {
        ...
        },
        {
          ...
          annee: "2018",
          description:
            "Ce projet universitaire a été développé par Antoine Barbier, Djamel Benameur, Timoléon Demas et Matthieu Commins.",
          membres: [
            { name: "Antoine Barbier", url: "https://www.antoinebarbier.fr" },
            {
              name: "Djamel Benameur",
        ...
        },
        {
          ...
          langage: "Python",
          annee: "2017",
          description: `Ce projet de jeu vidéo de style Mario Bros a été développé en Python avec mon ami Raphael Gimenez.`,
          membres: [
            { name: "Antoine Barbier", url: "https://www.antoinebarbier.fr" },
          ...
          images: [
            {
              image: "projet-bebert/bebertProject.png",
              alt: "Jeu vidéo Bébert - Constructeur de niveau",
            },
            {
              image: "projet-bebert/splashscreen.png",
              alt: "Jeu vidéo Bébert - Constructeur de niveau",
            },
            {
              image: "projet-bebert/jeu.png",
              alt: "Jeu vidéo Bébert - Constructeur de niveau",
            },
            {
              image: "projet-bebert/editeur-niveau.png",
              alt: "Jeu vidéo Bébert - Constructeur de niveau",
            },
          ],
          tags: [{ name: "python" }, { name: "pygame" }],
          website: "",
  ...
  computed: {
    ...
    parserDescription: function () {
      ...
      for (const membre of this.project?.membres) {
        text = text.replace(
          membre.name,
          `<a href="${membre.url} "target="_blank" title="${membre.url}" >$&</a>`
        );
      }
      return text;
    },
